    ...
    /******/ [
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            Game.prototype.getAllObjects = function () {
                return [].concat(this.ufo, this.shieldPieces, this.bullets, this.stars, this.powerUps);
            };
            ...
            Game.prototype.isOutOfBounds = function (pos) {
                return pos[0] < -50 || pos[1] < 0 || pos[0] > this.DIM_X + 50 || pos[1] > this.DIM_Y;
            };

            Game.prototype.collisionObjects = function () {
                return [].concat(this.bullets, this.invaderShips, this.defender, this.shieldPieces, this.ufo, this.powerUps);
            };
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            Ship.prototype.removeShip = function (shipToRemove) {
                this.game.invaderShips.forEach((ship) => {
                    if (ship.id === shipToRemove.id) {
                        this.game.invaderShips = this.game.invaderShips.filter((s) => s.id !== shipToRemove.id);
                    }
                });
            };
            ...
            Ship.prototype.respawn = function () {
                ...
                setTimeout(() => {
                    this.pos = [(this.canvasSize[0] - 30) * 0.52, this.canvasSize[1] - 70];
                    this.vel = [0, 0];
